...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    DatabaseReference myRef = database.getReference("personRegistered");
...
// display error
    ...
    //Adding user to Bismarck and Firebase at the same time
    ...
    public void onSubmit(View view) {
        ...
        if (password.equals("") || userNickName.equals("") || userCity.equals("")) {
            Toast.makeText(this, "Please Fill all the details described above", Toast.LENGTH_LONG).show();
...
//Process response here
        ...
        FirebaseDB user = new FirebaseDB(userNickName, email, userCountry, userState);
        myRef.child(userNickName).setValue(user);
    ...
    public void logginIn(View view) {
        Intent dial = new Intent(this, login.class);
        startActivity(dial);
    }
